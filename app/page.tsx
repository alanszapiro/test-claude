...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      {/* Hero Banner */}
      <section className="bg-[#C01818] text-white py-10 px-4">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center gap-6">
          <div className="flex-1">
            <h1 className="text-3xl sm:text-4xl font-extrabold leading-tight mb-2">
              Bem-vindo ao<br />
              <span className="text-white drop-shadow">Adara Café</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4 text-sm">
              <div className="flex items-center gap-1">
                <span>⏱️</span>
                <span className="text-red-100">20–40 min</span>
              </div>
              <div className="flex items-center gap-1">
                <span>🚴</span>
                <span className="text-red-100">Entrega grátis</span>
              </div>
              <div className="flex items-center gap-1">
                <span>⭐</span>
                <span className="text-red-100">4.9 (312 avaliações)</span>
              </div>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-[#C01818] text-red-100 text-center py-6 mt-8 text-sm">
        <p className="font-bold text-white text-base">Adara Café</p>
